  ...
  Map<String, dynamic> _payloadFor(UserRole role) => switch (role) {
    ...
    UserRole.student => {
      'modules': {
        ...
        ModuleCatalog.hostel: {
          'scope': 'own',
          'features': {
            'residency': ['read', 'create', 'update'],
            'application': ['create', 'read'],
            'outpass': ['create', 'read'],
            'mess': ['read', 'update'],
            'complaints': ['create', 'read'],
            'room_change': ['create', 'read'],
            'visitors': ['create', 'read'],
            'clearance': ['create', 'read'],
          },
        },
      },
    },
    UserRole.staff => {
      'modules': {
        ...
        ModuleCatalog.hostel: {
          ...
          'features': {
            'residency': ['read', 'create', 'update'],
            'application': ['create', 'read', 'approve'],
            'inventory': ['read', 'update', 'create'],
            'outpass': ['create', 'read', 'approve', 'update'],
            'movement': ['create', 'read', 'update'],
            'mess': ['read', 'update'],
            'complaints': ['create', 'read', 'update'],
            'room_change': ['create', 'read', 'approve'],
            'visitors': ['create', 'read', 'approve'],
            'clearance': ['create', 'read', 'approve', 'update'],
          },
        },
      },
    },
